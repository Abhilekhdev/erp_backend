// Full currency list from the legacy ERP (ids preserved for data-import fidelity).
// Symbols corrected to proper Unicode (the SQL dump stored double-encoded mojibake).
...
export const CURRENCIES: CurrencySeed[] = [
  ...
  { id: 12, country: 'Belize', currency: 'Dollars', code: 'BZD', symbol: 'BZ$' },
  ...
  { id: 95, country: 'Philippines', currency: 'Pesos', code: 'PHP', symbol: '₱' },
  ...
  { id: 99, country: 'Russia', currency: 'Rubles', code: 'RUB', symbol: '₽' },
  ...
  { id: 119, country: 'Turkey', currency: 'Lira', code: 'TRY', symbol: '₺' },
  ...
  { id: 132, country: 'Iraq', currency: 'Iraqi dinar', code: 'IQD', symbol: 'ع.د' },
  { id: 133, country: 'Kenya', currency: 'Kenyan shilling', code: 'KES', symbol: 'KSh' },
  { id: 134, country: 'Bangladesh', currency: 'Taka', code: 'BDT', symbol: '৳' },
  { id: 135, country: 'Algeria', currency: 'Algerian dinar', code: 'DZD', symbol: 'دج' },
  { id: 136, country: 'United Arab Emirates', currency: 'UAE dirham', code: 'AED', symbol: 'د.إ' },
