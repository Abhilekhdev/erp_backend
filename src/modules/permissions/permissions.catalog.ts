...
export const PERMISSION_CATALOG: PermGroup[] = [
  ...
  },
  {
    ...
    label: 'POS',
    items: [
      cb('sell.view', 'View POS sales'),
      cb('sell.create', 'Add POS sales'),
      cb('sell.update', 'Edit sales'),
      cb('sell.delete', 'Delete sales'),
  ...
  },
  {
    ...
    items: [
      ...
      cb('view_paid_sells_only', 'View paid sales only'),
      cb('view_due_sells_only', 'View due sales only'),
      cb('view_partial_sells_only', 'View partially-paid sales only'),
      cb('view_overdue_sells_only', 'View overdue sales only'),
      ...
      cb('view_commission_agent_sell', 'View commission agent sales'),
      cb('sell.payments', 'Add sales payment'),
      cb('edit_sell_payment', 'Edit sales payment'),
      cb('delete_sell_payment', 'Delete sales payment'),
      ...
      cb('access_sell_return', 'Access all sales returns'),
      cb('access_own_sell_return', 'Access own sales returns'),
